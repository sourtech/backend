        ...
        list +=`
            <div class="col-md-4">
                <div class="card text-bg-light mb-3">
                    <h4 class="card-header">#${prod.id} ${prod.title}</h4>
                    <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Imagenes: ${prod.thumbnails}</li>
                    </ul>  
                    <div class="card-body text-center">
                        <a href="#" class="btn btn-primary delete" data-id="${prod.id}">Borrar</a>                    
                    </div>                               
                </div>
            </div>
        `;        
